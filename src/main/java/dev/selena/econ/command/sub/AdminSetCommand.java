...
public class AdminSetCommand extends AbstractAsyncCommand {
    ...
    private void command(CommandContext commandContext, ProfileServiceClient.PublicGameProfile playerProfile, double amount) {
        ...
        commandContext.sender().sendMessage(
                PlaceholderUtil.parsePlaceholdersToMessage(Lang.get().getAdminSetBalance(),
...
//    @Override
//    protected void execute(@NotNull CommandContext commandContext, @Nullable Ref<EntityStore> source, @NotNull Ref<EntityStore> ref, @NotNull PlayerRef playerRef, @NotNull World world, @NotNull Store<EntityStore> store) {
//        CurrencyComponent wallet = CurrencyUtil.getOrAddCurrencyComponent(playerRef.getReference());
//        wallet.setBalance(commandContext.get(amountArg));
//        String formattedAmount = CurrencyUtil.formatCurrency(commandContext.get(amountArg));
//        String formattedBal =  CurrencyUtil.formatCurrency(wallet.getBalance());
//        commandContext.sender().sendMessage(
//                PlaceholderUtil.parsePlaceholdersToMessage(Lang.get().getAdminSetBalance(),
//                        Placeholders.AMOUNT, formattedAmount,
//                        Placeholders.TARGET_PLAYER, playerRef.getUsername(),
//                        Placeholders.BALANCE, formattedBal
//                ));
//
